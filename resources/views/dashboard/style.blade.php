...
.sidebar {
  ...
  background: rgba(10, 37, 88, 0.7) !important; /* Make the background 70% opaque */
  box-shadow: 8px 4px 6px rgba(0, 0, 0, 0.1); /* Add shadow effect */
  padding: 10px;
  border-radius: 5px;
...
.card-header{
  background: rgba(10, 37, 88, 0.7) !important; 
...
.form-control.bg-body.shadow-sm {
        border-color: rgba(10, 37, 88, 0.7); 
        border-radius:5px;
    }
