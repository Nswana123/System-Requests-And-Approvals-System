    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col col-xl-10">
        <div class="card" style="border-radius: 1rem;">
          <div class="row g-0 center-container">
            <div class="col-md-6  col-lg-5 text-align: center; d-none d-md-block">
            
    <img src="/assets/img/zed.png" alt="Zedlog"  class="center-img">
