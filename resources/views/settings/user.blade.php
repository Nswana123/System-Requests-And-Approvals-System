...
<div class="row">
    ...
    <div class="col">
        ...
        <select class="form-control bg-body @error('dept_name') is-invalid @enderror" name="dept_id" required autocomplete="off">
                    <option>Select Group</option>
                    @foreach($groups as $group)
                        <option value="{{ $group->id }}" {{ old('dept_name') == $group->id ? 'selected' : '' }}>
                            {{ $group->dept_name }}  {{ $group->position }}
                        </option>
                    @endforeach
                </select>
            @error('dept_name')
...
<div class="row mt-3">
    <div class="col">
        <div class="card bg-body shadow-sm">
            <div class="card-header p-3 text-white float-center shadow-lg" style=" border-radius: 5px;">
                <div class="row">
                    <div class="col">
                        All User
                    </div>
                        ...
                        <div class="table-wrapper">
                                ...
                                <table class="table" id="my-table">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $user->user_dept->dept_name }}</td>
                                        <td>{{ $user->user_dept->position }}</td>
                                        <td>{{ $user->status }}</td>
                                        <td>
