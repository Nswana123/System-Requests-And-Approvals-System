...
<div class="row">
    ...
    <div class="col">
        ...
        <select class="form-control bg-body @error('group_name') is-invalid @enderror" name="user_dept_id" required autocomplete="off">
                                    ...
                                    <tbody>
                                        @foreach($roles as $role)
                                            <tr>
                                                ...
                                                <td>{{ $role->user_dept->dept_name }} {{ $role->user_dept->position }}</td>
