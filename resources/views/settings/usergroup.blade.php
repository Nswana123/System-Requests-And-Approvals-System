...
<div class="row">
    ...
    <div class="row">
        <div class="col">
            <label>User Deptment</label>
            <input type="text" class="form-control bg-body shadow-sm @error('dept_name') is-invalid @enderror" name="dept_name" value="{{ old('dept_name') }}" required autocomplete="off">
            @error('dept_name')
        ...
        <div class="col">
            ...
            <input type="text" class="form-control bg-body shadow-sm @error('position') is-invalid @enderror" name="position" value="{{ old('position') }}" required autocomplete="off">
            @error('position')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
...
<div class="row mt-3">
    <div class="col">
        <div class="card bg-body shadow-sm">
            <div class="card-header p-3 text-white float-center" style="border-radius: 5px;">
                <div class="row">
                    <div class="col">
                        All User Deptments
                    </div>
                        ...
                        <div class="table-wrapper">
                            ...
                            @else
                                <table class="table" id="my-table">
                                    ...
                                    <tbody>
                                        @foreach($user_dept as $group)
                                            <tr>
                                                <td>{{ $loop->iteration }}</td>
                                                <td>{{ $group->dept_name }}</td>
