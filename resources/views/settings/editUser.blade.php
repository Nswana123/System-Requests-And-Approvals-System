...
<div class="row">
    ...
    <div class="col">
        ...
        <select class="form-control bg-body @error('group_name') is-invalid @enderror" name="dept_id" required autocomplete="off">
    <option>Select Group</option>
    @foreach($groups as $group)
        <option value="{{ $group->id }}" 
            {{ old('dept_id', $users->dept_id) == $group->id ? 'selected' : '' }}>
