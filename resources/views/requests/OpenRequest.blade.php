    ...
    <tbody>
        @foreach ($dept_request_type as $request_type)
            <tr>
                ...
                <td>
                    <a href="{{ route('requests.editOpenRequest', $request_type->id) }}" class="custom-link" title="Request Reference">{{ $request_type->request_refference }}</a>
                </td>
