...
@endif 
        <div class="card bg-body shadow-sm">
            <div class="card-header p-3 text-white" style="border-radius: 5px; background-color: #007bff;">
                ...
                <div class="row">
                <div class="col">
                <h4>Department Approved Requests</h4>
                </div>
    ...
    <tbody>
        @foreach ($dept_request_type as $request_type)
            <tr>
                ...
                <td>
                    <a href="{{ route('requests.editFirstApproval', $request_type->id) }}" class="custom-link" title="Request Reference">{{ $request_type->request_refference }}</a>
                </td>
