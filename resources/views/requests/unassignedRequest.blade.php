    ...
    <tbody>
        @foreach ($request_types as $request_type)
            <tr>
                ...
                <td>
                    <a href="{{ route('requests.editUnassignedRequest', $request_type->id) }}" class="custom-link" title="Request Reference">{{ $request_type->request_refference }}</a>
                </td>
