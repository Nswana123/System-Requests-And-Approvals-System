...
@php
                ...
                @endphp
                @if(!($user_dept && ($user_dept->position === 'HOD')))
<div class="row">
    ...
    <tbody>
        @foreach ($dept_request_type as $request_type)
            <tr>
                ...
                <td>
                    <a href="{{ route('requests.editAssignedRequest', $request_type->id) }}" class="custom-link" title="Request Reference">{{ $request_type->request_refference }}</a>
                </td>
