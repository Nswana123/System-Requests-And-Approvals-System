...
@endif 
        <div class="card bg-body shadow-sm">
            <div class="card-header p-3 text-white" style="border-radius: 5px; background-color: #007bff;">
                ...
                <div class="row">
                <div class="col">
                <h4>All Department Requests <span class="badge badge-danger">{{$dept_request_type_count}}</span></h4> 
                </div>
...
@endif
        ...
        @php
                ...
                @if($user_dept && ($user_dept->dept_name === 'super admin' || $user_dept->dept_name === 'IT System Admin'))
        <td> 
        @if($request_type->access_state == 'Active')
       
        <form action="{{ route('deactivateAccess', $request_type->id) }}" method="POST" style="display:inline;">
            @csrf
            @method('PATCH')
            <button type="submit" class="btn btn-warning btn-sm">Deactivate</button>
        </form>
    @else
        <form action="{{ route('activateAccess', $request_type->id) }}" method="POST" style="display:inline;">
            @csrf
            @method('PATCH')
