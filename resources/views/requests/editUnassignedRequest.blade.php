    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="assignTicketModalLabel">Request Assignment</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="assignTicketForm" action="{{ route('RequestAssignment') }}" method="POST">
                    @csrf
                    <input type="hidden" name="request_id" id="request_id" value="{{ $record->id ?? '' }}">
                    <div class="row">
                        <div class="input-group">
                        <select class="form-select" id="user" name="assigned_user" required>
